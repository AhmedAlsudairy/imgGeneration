...
if (form.prompt) {
  ...
  try {
    ...
    const response =  await fetch('http://localhost:8881/api/v1/dalle',
    {
...
<FormField labelName ="YourName" type="text" name="name" placeholder="John Doe" value={form.name} handleChange={handleChange}/>
...
{generatingImg && (<div className="absolute inset-0 z-0 flex justify-center items-center bg-[rgba(0,0,0.5)]"><Loader/></div>)}
